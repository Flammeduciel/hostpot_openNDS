...
# ============================================================
# SCRIPT V3 TEST : HOTSPOT + OPENNDS - VERSION SANS INTERNET
# Auteur   : Script original V3 adapté pour mode test sans internet
# But      : Transformer un Raspberry Pi en hotspot Wi-Fi autonome
#            avec portail captif (voucher) - PAS DE CONNEXION INTERNET
#
# MODE TEST SANS INTERNET :
#   - Ne nécessite PAS de câble Ethernet branché
#   - Crée un hotspot Wi-Fi autonome
#   - Les clients peuvent se connecter au portail captif
#   - PAS d'accès internet (test uniquement)
# ============================================================
...
echo "======================================================"
echo "   Installation Hotspot + OpenNDS - MODE TEST SANS INTERNET"
echo "======================================================"


# ============================================================
# DÉTECTION AUTOMATIQUE DE L'INTERFACE WI-FI UNIQUEMENT
# ============================================================
# MODE TEST : On ne détecte QUE l'interface Wi-Fi
# Pas besoin d'interface Ethernet pour le mode test sans internet
#
...
# Pas d'interface Ethernet en mode test
ETH_IF="none"

# Si aucune interface Wi-Fi n'est trouvée, on arrête tout.
...
# On informe l'utilisateur que c'est le mode test sans internet
echo ""
echo "  MODE TEST SANS INTERNET ACTIVÉ"
echo "  Interface Wi-Fi détectée : $WIFI_IF"
echo "  Pas d'interface Ethernet requise"
echo "  Les clients pourront se connecter au hotspot mais SANS accès internet"
echo ""
...
# ============================================================
# ÉTAPE 6/8 — CONFIGURATION IPTABLES (MODE TEST SANS INTERNET)
# ============================================================
# IPTables est le pare-feu Linux. On l'utilise pour :
#   A. CRÉER UN RÉSEAU LOCAL AUTONOME (PAS DE NAT/PARTAGE INTERNET)
...
#
# MODE TEST : PAS DE PARTAGE INTERNET - UNiquement hotspot local
# ============================================================
echo "[6/8] Configuration IPTables pour mode test sans internet..."
...
# ==========================================================
# A. PAS DE RÈGLES NAT - MODE TEST SANS INTERNET
# ==========================================================
# MODE TEST : On ne configure PAS de NAT/MASQUERADE
# car il n'y a pas de connexion internet à partager.
# Le hotspot fonctionne en réseau local autonome.
echo "  -> Mode test : Pas de configuration NAT (pas d'internet)"
...
# SSH : autorisé sur toutes les interfaces en mode test
# car pas d'interface filaire pour administration sécurisée
...
# ==========================================================
# RÉCAPITULATIF FINAL - MODE TEST SANS INTERNET
# ==========================================================
echo ""
echo "======================================================"
echo "   INSTALLATION TERMINÉE - MODE TEST SANS INTERNET"
echo "======================================================"
echo ""
echo "  SSID (nom du réseau) : $SSID"
echo "  Interface Wi-Fi      : $WIFI_IF"
echo "  Mode                 : TEST SANS CONNEXION INTERNET"
echo "  IP du portail        : http://192.168.50.1"
echo "  Port auth OpenNDS    : 2050"
echo ""
echo "  Codes voucher disponibles :"
echo "    1H    → 60 minutes d'accès AU RÉSEAU LOCAL"
echo "    30M   → 30 minutes d'accès AU RÉSEAU LOCAL"
echo "    ADMIN → 24 heures d'accès AU RÉSEAU LOCAL"
echo ""
echo "  ⚠️  IMPORTANT : PAS D'ACCÈS INTERNET - MODE TEST UNIQUEMENT"
echo "  Les clients peuvent se connecter au hotspot mais navigueront"
echo "  uniquement sur les services locaux (portail captif)"
echo "  SSH autorisé sur toutes les interfaces pour administration"
echo ""
echo "======================================================"
echo ""
